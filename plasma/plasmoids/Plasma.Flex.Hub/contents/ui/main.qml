...
PlasmoidItem {
    ...
    property bool activeWeather: false

    property var weatherData: if (weatherLoader.item) weatherLoader.item

    Loader {
        id: weatherLoader
        active: activeWeather
        sourceComponent:  weatherDataRob
    }

    Component { id: weatherDataRob;    Components.WeatherData {} }
